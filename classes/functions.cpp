...
Dog::Dog(std::string n, std::string b, int a, double w)
{
	name = n;
	breed = b;
	age = a;
...
Helicopter::Helicopter(std::string n, std::string t, int s, int c)
{
	name = n;
	type = t;
	speed = s;
...
void Helicopter::setName(std::string n)
{
	name = n;
}
...
void Helicopter::setType(std::string t)
{
	type = t;
}
...
Hospital::Hospital(std::string n, std::string l, std::string p, std::string w, std::string web, std::string s, std::string d, int pr, int a)
{
	name = n;
	location = l;
	phone_number = p;
...
void Hospital::setName(std::string n)
{
	name = n;
}
...
void Hospital::setLocation(std::string l)
{
	location = l;
}
...
void Hospital::setPhone_number(std::string p)
{
	phone_number = p;
}
...
void Hospital::setWork_time(std::string w)
{
	work_time = w;
}
...
void Hospital::setWebsite(std::string w)
{
	website = w;
}
...
void Hospital::setService(std::string s)
{
	service = s;
}
...
void Hospital::setDoctor_name(std::string d)
{
	doctor_name = d;
}
